...
#
#
# Forked from http://reverse.put.as
...
set extended-prompt \[\e[36m\]gdb\[\e[0m\] > 
...
# _____________By_Sebastien_Chapuis___________

define preload
  if $argc == 0
    help preload
  else
    set env LD_PRELOAD $arg0
  end
end
document preload
Syntax: preload LIB
| Set LIB in the environment with LD_PRELOAD key.
end
